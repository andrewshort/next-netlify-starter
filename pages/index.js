...
export async function getServerSideProps(context) {
  ...
  const res = await fetch(`https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=d6604d8d7191bf60573307fabdddc2f4&has_geo=1&extras=geo&lat=` + lat + `&lon=` + lng + `&radius=5&format=json&nojsoncallback=1`)
